...
class RefreshInitiative : CliktCommand() {
    private val refreshInitiative:
        br.usp.inovacao.hubusp.curatorship.sheets.RefreshInitiative by lazy {
        br.usp.inovacao.hubusp.curatorship.sheets.RefreshInitiative(
            ...
            initiativeRepository = InitiativeRepositoryImpl(Refresh.db),
            initiativeErrorRepository = InitiativeErrorRepositoryImpl(Refresh.db),
        )
    }
