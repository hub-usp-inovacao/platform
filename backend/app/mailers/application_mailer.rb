...
class ApplicationMailer < ActionMailer::Base
  ...
  def skill_update_data(sheet)
    ...
    mail(subject: subject('Atualização de Competências'), cc: [ENV['email_devs_username'],ENV['email_copy_username']])
  end
  ...
  def warnings
    ...
    mail(subject: subject("Aviso semanal de #{@entity}"), cc: [ENV['email_devs_username'],ENV['email_copy_username']])
  end
