    ...
    sections: [
      ...
      },
      {
        ...
        people: [
          {
            src:
              "https://drive.google.com/uc?export=view&id=1j7Gjoeg7YGh0qazxliPyPGSE8am7BILj",
            name: "Luiz Henrique Catalani",
            role: "Coordenador",
          },
          {
            src:
              "https://drive.google.com/uc?export=view&id=1GT0L01cWJzllGbMH_bnim6yEQtHLiTmV",
          ...
          {
            src:
              "https://drive.google.com/uc?export=view&id=1cm_a1B4FuDah5Ov1tsf2jMJK1eZbtUVk",
            name: "Neylor Fabiano",
            role: "Hub USP Inovação",
          },
          {
      ...
      },
      {
        ...
        people: [
          ...
          {
            src:
              "https://drive.google.com/uc?export=view&id=1fBO0461oSTPapARTnfWNYXc5edWsBwH_",
            name: "Briza Mel",
            role: "Desenvolvedor - CodeLaba",
          },
          {
            src:
              "https://drive.google.com/uc?export=view&id=1mOcHd5Zzm82P4jADIalg43X8ysJo01ye",
