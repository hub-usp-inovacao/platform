...
const actions = {
  setSkills: ({ commit }, newList) => commit("setSkills", newList),

  setEquipments: ({ commit }, newList) => commit("setEquipments", newList),

  setServices: ({ commit }, newList) => commit("setServices", newList),
